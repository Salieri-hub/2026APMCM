...
$jobs = @(
    @{ Name = "v2.0_pretrained_ce_b4"; Args = @("--pretrained", "--loss", "cross_entropy") }
    @{ Name = "v2.1_pretrained_ce_cosine_b4"; Args = @("--pretrained", "--loss", "cross_entropy", "--scheduler", "cosine") }
    @{ Name = "v2.2_pretrained_ce_ls_b4"; Args = @("--pretrained", "--loss", "cross_entropy", "--label-smoothing", "0.1") }
    @{ Name = "v2.3_pretrained_ce_ls_cosine_b4"; Args = @("--pretrained", "--loss", "cross_entropy", "--label-smoothing", "0.1", "--scheduler", "cosine") }
    @{ Name = "v2.4_pretrained_ce_ls_cosine_weightedce_b4"; Args = @("--pretrained", "--loss", "cross_entropy", "--label-smoothing", "0.1", "--scheduler", "cosine", "--class-weighting", "balanced") }
    @{ Name = "v3.0_pretrained_focal_ls_cosine_b4"; Args = @("--pretrained", "--loss", "focal", "--label-smoothing", "0.1", "--scheduler", "cosine") }
    @{ Name = "v3.1_pretrained_focal_ls_cosine_mixup_b4"; Args = @("--pretrained", "--loss", "focal", "--label-smoothing", "0.1", "--scheduler", "cosine", "--mixup-alpha", "0.2") }
    @{ Name = "v3.2_pretrained_focal_ls_cosine_cutmix_b4"; Args = @("--pretrained", "--loss", "focal", "--label-smoothing", "0.1", "--scheduler", "cosine", "--cutmix-alpha", "0.5") }
    @{ Name = "v3.3_pretrained_focal_ls_cosine_se_b4"; Args = @("--pretrained", "--loss", "focal", "--label-smoothing", "0.1", "--scheduler", "cosine", "--feature-attention", "se") }
    @{ Name = "v3.4_pretrained_focal_ls_cosine_cbam_b4"; Args = @("--pretrained", "--loss", "focal", "--label-smoothing", "0.1", "--scheduler", "cosine", "--feature-attention", "cbam") }
)
...
$logPath = Join-Path $logDir "run_all_efficientnet_b4_50_$timestamp.log"
...
try {
    ...
    Write-Host ""
    Write-Host "All EfficientNet-B4 formal experiments finished."
